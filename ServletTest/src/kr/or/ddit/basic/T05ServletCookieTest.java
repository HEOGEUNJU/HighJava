...
public class T05ServletCookieTest extends HttpServlet {
	 ...
	 * 
	 * 2. 동작방식 - 쿠키생성단계 : 생성한 쿠키를 응답데이터의 헤더에 저장하여 웹브라우저에 저장한다.
	 * 
...
//		readCookieExam(req, resp); // 쿠키 정보읽기 예제
	 ...
	 */
		...
		out.println("<html><head><titlt>" + title
				+ "</title></head>"
				+ "<body>");
	...
	private void setCookieExam(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		out.println("<html><head><title>" + title + "</title></head>" + "<body>" + "<h1 align = \"center\"" + title
				+ "</h1>" + "<ul>" + "<li><b>ID</b>:" + req.getParameter("userId") + "</li>" + "<li><b>이름</b>:"
